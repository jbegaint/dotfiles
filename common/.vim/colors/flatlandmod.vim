...
" moded by jbt (WIP) for 256-color terminal use
...
hi Cursor ctermfg=16 ctermbg=235 cterm=NONE guifg=#26292c guibg=#646769 gui=NONE
hi Visual ctermfg=NONE ctermbg=237 cterm=NONE guifg=NONE guibg=#515559 gui=NONE
hi CursorLine ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#3b3e40 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#3b3e40 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#3b3e40 gui=NONE
hi LineNr ctermfg=246 ctermbg=237 cterm=NONE guifg=#8f9192 guibg=#3b3e40 gui=NONE
...
hi StatusLine ctermfg=255 ctermbg=241 cterm=bold guifg=#f8f8f8 guibg=#636567 gui=bold
hi StatusLineNC ctermfg=255 ctermbg=241 cterm=NONE guifg=#f8f8f8 guibg=#636567 gui=NONE
hi Pmenu ctermfg=74 ctermbg=236 cterm=NONE guifg=#72aaca guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#3c3f42 gui=NONE
hi IncSearch ctermfg=16 ctermbg=255 cterm=NONE guifg=#26292c guibg=#f6f6f6 gui=NONE
...
" hi Normal ctermfg=255 ctermbg=235 cterm=NONE guifg=#f8f8f8 guibg=#26292c gui=NONE
hi Normal ctermfg=255 ctermbg=235 cterm=NONE guifg=#f8f8f8 guibg=#26292c gui=NONE
...
hi DiffAdd ctermfg=255 ctermbg=64 cterm=bold guifg=#f8f8f8 guibg=#46830e gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8b0809 guibg=NONE gui=NONE
hi DiffChange ctermfg=255 ctermbg=23 cterm=NONE guifg=#f8f8f8 guibg=#233a5a gui=NONE
hi DiffText ctermfg=255 ctermbg=24 cterm=bold guifg=#f8f8f8 guibg=#204a87 gui=bold
hi ErrorMsg ctermfg=255 ctermbg=124 cterm=NONE guifg=#f8f8f8 guibg=#aa2915 gui=NONE
hi WarningMsg ctermfg=255 ctermbg=124 cterm=NONE guifg=#f8f8f8 guibg=#aa2915 gui=NONE
...
hi Label ctermfg=255 ctermbg=NONE cterm=NONE guifg=#f6f6f6 guibg=NONE gui=NONE
hi NonText ctermfg=102 ctermbg=235 cterm=NONE guifg=#7a8288 guibg=#313336 gui=NONE
...
hi SpecialKey ctermfg=102 ctermbg=235 cterm=NONE guifg=#7a8288 guibg=#3b3e40 gui=NONE
...
hi String ctermfg=255 ctermbg=NONE cterm=NONE guifg=#f6f6f6 guibg=NONE gui=NONE
...
hi rubyStringDelimiter ctermfg=255 ctermbg=NONE cterm=NONE guifg=#f6f6f6 guibg=NONE gui=NONE
...
hi yamlDocumentHeader ctermfg=255 ctermbg=NONE cterm=NONE guifg=#f6f6f6 guibg=NONE gui=NONE
...
hi TabLineSel gui=bold guifg=#c9cacb ctermfg=250 ctermbg=235 cterm=bold
